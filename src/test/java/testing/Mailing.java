...
public static void captureScreenshot() throws IOException
{
	...
	public static void main(String[] args) throws IOException, AddressException, MessagingException  {
		...
		mail.sendMail(TestConfig.server, TestConfig.from,TestConfig.to, TestConfig.subject, TestConfig.messageBody, screenshotpath, TestConfig.attachmentName);
		//mail.sendMail(mailServer, from, to, subject, messageBody, attachmentPath, attachmentName);
		//google security-allow less secure app on
